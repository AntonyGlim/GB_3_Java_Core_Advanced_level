...
public class ServerMain {
    ...
    ServerMain() throws IOException, InterruptedException {
        ...
        Thread threadOut = new Thread(new ServerOut(client));               //Создаем поток отвечающий за отправку информации
        Thread threadIn = new Thread(new ServerIn(client));                 //Создаем поток отвечающий за получение информации
